...
jrmatz.hdssrc f1 left join jrmatz.gemsrc f2 on f1.mlname =       
...
jrmatz.gemsrc f1 left join jrmatz.hdssrc f2 on f1.mlname =         
f2.mlname and f1.mlseu2 = f2.mlseu2 WHERE not exists (Select * from
jrmatz.hdssrc f3 where f3.mlname = f1.mlname and f3.mlseu2 =       
f1.mlseu2) ";
$r = db2_exec($con, $s);
while ($row=db2_fetch_assoc($r)){
